  ...
  return (
    <div className="  flex flex-col pt-36 h-screen">
      ...
      <div className="flex flex-row p-5 lg:w-1/2  justify-evenly   gap-5">
        <input
          className="w-full flex flex-grow border border-zinc-300 "
          placeholder="Type to search"
        />
        <button className={`bg-[#676767] hover:bg-[#2Escrollbar scrollbar-thumb-blue-600 scrollbar-thumb-roundedCDFF] border border-[#2ECDFF]  text-white font-semibold py-1 px-5 rounded-full`}>
            Current
        </button>
        <button className={`bg-[#676767] hover:bg-[#2ECDFF] border border-[#2ECDFF]  text-white font-semibold py-1 px-5 rounded-full`}>
          Upcoming
        </button>
        <button className={`bg-[#676767] hover:bg-[#2ECDFF] border border-[#2ECDFF]  text-white font-semibold py-1 px-5 rounded-full`}>
          Past
