...
const Page = () => {
  ...
  return (
    <div className={`text-white themed-background relative h-fit w-screen pt-36 px-8 md:px-12`}>
      <Image src={'/elements/Gradient.svg'} layout='fill' alt='footer background' className='absolute top-0 rotate-180 pointer-events-none  opacity-50 '></Image>
      <motion.div
