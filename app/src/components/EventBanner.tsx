...
const EventBanner = ({event}:{event:{name:string,details:string}}) => {
  return (
    <Link href={'/'} className={ ` w-screen fixed z-[200] overflow-hidden py-1 bg-gradient-to-r mt-[88px] from-[#FFFFFF00] from-0% via-[#FFFFFF] via-50% to-[#FFFFFF00] to-100% flex items-center hover:bg-white hover:py-2 transition-all ease-in-out duration-200 backdrop-blur-2xl `}>
