      ...
      >
        ...
        <div className="flex flex-col gap-5 ">
          ...
          >
            ...
            <span className="font-normal text-underline">inculcating the spirit</span>{" "}
            in students. The members have identified the{" "}
            <span className="font-normal text-underline">true joy of self-learning</span>{" "}
            and they passionately involve in bringing life into their ideas, to solve the problems that they see around.
          </motion.p>
        </div>
