...
const HeroSection = () => {
  ...
  return (
        ...
        <div className="w-screen h-fit -z-10 mt-32  overflow-hidden  flex flex-col items-center pt-20 px-8 relative">
          <Image src={'./elements/Gradient.svg'} layout='fill' alt='footer background' className='absolute z-10  top-0 '></Image>
          <div className='w-full rounded-3xl pt-20 bg-white relative overflow-hidden h-[600px] text-center   event-background mb-10'>
        
            <h1 className=" md:text-4xl tracking-tighter  text-center font-medium text-black">Catalyst Mar Baselios IEDC</h1>
            <div className="text-[#000000e8] text-6xl z-[200] font-medium text-center mx-auto tracking-[-3.15px] leading-[70px] w-3/4">Where aspiring entrepreneurs become empowered innovators</div>
