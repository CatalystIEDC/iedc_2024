...
const HeroSection = () => {
  return (
    <div className="w-screen h-[85vh]  mt-32   overflow-hidden  flex flex-col items-center  px-8 relative ">
      <div
        className={`uppercase mt-10 md:mt-5 font-semibold tracking-tighter text-white text-[12dvw] leading-10 text-center  md:text-[10dvw] lg:text-[5dvw] z-[50] md:leading-[100px] md:text-center ${dm.className}`}
      >
      ...
      <Image
        ...
        className="absolute z-10   md:scale-100 scale-125  top-0 opacity-100 mix-blend-overlay"
      ></Image>
      <Image
        alt="bg-main"
        src={"/bg-main.png"}
